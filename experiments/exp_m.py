...
from utils.tools import EarlyStopping, adjust_learning_rate, save_model, load_model, MyDefiniteSampler
from metrics.ETTh_metrics import metric
from models.SCINet import SCINet
import torch.distributed as dist


class Exp_M(Exp_Basic):
    def __init__(self, args):
        super(Exp_M, self).__init__(args)
    ...
    def train(self, setting):
        ...
        for epoch in range(epoch_start, self.args.train_epochs):
            ...
            lr = adjust_learning_rate(W_optim, epoch + 1, self.args)
    ...
    def test(self, setting, evaluate=False):
        ...
        if self.args.stacks == 1:
            ...
            if self.args.save:
                ...
                mae, mse, rmse, mape, mspe, corr = metric(preds, trues)
                print('Test:mse:{:.4f}, mae:{:.4f}, rmse:{:.4f}, mape:{:.4f}, mspe:{:.4f}, corr:{:.4f}'.format(mse, mae,
                                                                                                               rmse,
                                                                                                               mape,
                                                                                                               mspe,
                                                                                                               corr))
